...
This guide walks through the end-to-end process of running the TB variant-calling pipeline (`tbvarpipe`) hosted in the `amd-ph-core` GitHub namespace: [Quickstart Guide](docs/quick_start_guide.md)
